# -*- coding: utf-8 -*-
#
# indigenous-mt documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'indigenous-mtdoc'
...
latex_documents = [
    ('index',
     'indigenous-mt.tex',
     u'indigenous-mt Documentation',
     u"Cameron Bishop", 'manual'),
]
